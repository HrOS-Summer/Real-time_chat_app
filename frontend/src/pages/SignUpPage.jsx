...
const SignUpPage = () => {
  ...
  const validateForm = () => {
    ...
    if(formData.fullName.length < 4) return toast.error("Full name must be atleast 4 characters")
  ...
  return (
    <div className='min-h-screen grid lg:grid-cols-2'>
      ...
      <div className="flex flex-col justify-center items-center p-6 sm:p-12">
        <div className="w-full max-w-md md:max-w-sm space-y-8">
          {/* LOGO */}
